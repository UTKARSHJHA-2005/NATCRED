...
1) Clone the Repository<br/>
   ```
   git clone https://github.com/UTKARSHJHA-2005/NATCRED.git
   cd NATCRED
   cd client and cd backend
   ```
   <br/>
2) Install The Dependencies (for both client and backend)
   ```
   npm install
   ```
   <br/>
3) env for backend<br/>
   <pre>
   ...
   VITE_OPENROUTER=YOU_OPENROUTER_API
   PORT=5000
   FIREBASE_PRIVATE_KEY=YOUR_FIREBASE_PRIVATE KEY
   </pre>
   <br/>
4) Run the server(for both client and backend)
   ```
   npm run dev
   ```
